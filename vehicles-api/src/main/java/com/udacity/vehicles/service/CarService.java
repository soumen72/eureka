...
public class CarService {
    ...
    public Car findById(Long id) {
        ...
        //using optianl to validate its existance
        Optional<Car> isCarPresent = repository.findById(id);
         ...
         */
        if (!isCarPresent.isEmpty()) {
            //get the car object
            Car car = isCarPresent.get();
            String price = priceClient.getPrice(id);
            car.setPrice(price);


            Location carLocation = car.getLocation();
            Location address = this.mapsClient.getAddress(carLocation);
